...
bitMaskTest = {
        'generalKCC': {'collides': ['environment','container','pickable','generalKCC'], 'exclude': ['kccEnvCheckerRay']},
        'container': {'collides': ['generallKCC','environment'], 'exclude': ['pickable','container']},
...
#p.addConstraint(lambda a,b,c,d: collides(a,b,c,d), ['generalKCC','generalKCC','generalKCCcat','generalKCCcat'])
