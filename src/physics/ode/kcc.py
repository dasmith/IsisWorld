...
class kinematicCharacterController(object):
    def __init__(self, physics, charNP=None):
        ...
        """
        self.geom = OdeCappedCylinderGeom(self.physics.getSpace(), self.radius, self.length)
        ...
        """
        self.footRay = rayObject(self.physics)
        ...
        self.physics.addObject(self.footRay)
        ...
        """
        self.envCheckerRay = rayObject(self.physics)
        ...
        self.physics.addObject(self.envCheckerRay)
