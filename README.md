...
When building a simulator, one is forced to chose a particular level of physical detail.  IsisWorld is a platform for AI systems that model everyday social problems involving reasoning about joint behavior, intention and communication.  The perceptual-motor granularity is too coarse to be adequate for testing robotics problems.  For more information about the simulator, including the indented audience and the motivation behind this approach to building intelligent agents, please refer to these resources: 
